...
class DataManagement:
    ...
    # Get the html pages from the json file correspondent to the streaming platform
    ...
    # Extract tweets data from the html pages
    ...
    # Get the username of the tweet author from the html
    ...
    # Get the tweet text from the html
    ...
    # Get the tweet timestamp from the html
    ...
    def main(self):
        for platform in self.streaming_platforms:
            ...
            # Get the html pages from a json file
            html_list = self.get_html_pages(platform)
            
            # Extract the tweet data from the html pages
            self.get_data_from_html(html_list, platform)
        
        # Store all the data extracted from all the html pages
        self.store_data()
